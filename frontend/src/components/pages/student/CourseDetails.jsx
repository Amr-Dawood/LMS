...
//         window.location.href = response.data.message; // this is Stripe session.url
//       }
//     } catch (error) {
...
//           </div>
//           <p className="text-sm">Course by <span className="text-blue-600 underline">Seif Elden</span></p>
...
//                     <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300t">
...
//                               <p>{humanizeDuration(lecture.lectureDuration * 600 * 1000, {units: ['h', 'm']})}</p>
//                             </div>
//                           </div>
//                         </li>
//                       ))}
...
//             <h3 className="text-xl font-semibold text-gray-800g">Course Description</h3>
